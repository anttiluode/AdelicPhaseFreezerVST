...
// ─────────────────────────────────────────────────────────────────────
// Adélic Phase-Freezer Processor
// ─────────────────────────────────────────────────────────────────────
class AdelicProcessor : public juce::AudioProcessor {
public:
    AdelicProcessor();
    ~AdelicProcessor() override = default;
    ...
    const juce::String getName() const override { return "Adelic Freezer"; }
    ...
    // GUI Scope Data (Takens Phase Space X, Y)
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(AdelicProcessor)
};